...
<head runat="server">
    <title>DigiStore</title>
     ...
     <!-- #back and #pageone im setting an image but not sure how to get it to show HELP -->
    ...
    <style>
        #FooterTag {
            ...
            text-align: center;
            z-index: 9999; //to make sure the footer is always on top and shown
        }
            ...
            <div data-role="page" id="pageone">
                ...
                <div data-role="main" class="ui-content" >
                    <div id="homepage">
                     ...
                     <!-- Registration page we have to ling it to the database still  -->
                    <div id="registrationpage" style="display: none;">
                        <form autocomplete="on">
                            ...
                            <p class="change_link">
                                Already a member ?
					<a class="to_register">Go and log in </a>
                            </p>
                        </form>
